...
function PopupClosed({ active, setActive }) {
      ...
      <div onClick={e => e.stopPropagation()}>
        <div className="popup__container">
          <div className="popup__wrapper">
            <h1 className="popup__title_closed">Данный продукт является закрытым, для покупки вам следует связаться с нами:</h1>
